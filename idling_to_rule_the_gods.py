...
def quick_rebirth():
    ...
    print(f'{Fore.GREEN}divinity.remove_all_clones() started at:{helpers.time_format()}\n')
    divinity.remove_all_clones()
    print(f'{Fore.GREEN}divinity.cap_max() started at:{helpers.time_format()}\n')
    divinity.cap_max()
    time.sleep(0.5)
    print(f'{Fore.GREEN}planet.power_surge() started at:{helpers.time_format()}\n')
    planet.power_surge()
    time.sleep(0.5)
    print(f'{Fore.GREEN}helpers.click_image_on_screen(IMAGE_DICTIONARY["max"]) started at:{helpers.time_format()}\n')
    helpers.click_image_on_screen(IMAGE_DICTIONARY["max"])
    time.sleep(0.5)
    print(f'{Fore.GREEN}monuments.build(monuments.TEMPLE_OF_GOD) started at:{helpers.time_format()}\n')
    ...
    print(f'{Fore.GREEN}IDLE_CYCLE finished at:{helpers.time_format()}\n')
    print(f'{Fore.GREEN}Creation_cycle_check started at:{helpers.time_format()}\n')
    while not creation.finished_cycle:
        creation.finished_cycle = creation.check_if_idle()
        pets.distribute()
        divinity.add_to_div()
        time.sleep(30)
    print(f'{Fore.GREEN}Creation_cycle_check finished at:{helpers.time_format()}\n')
    print(f'{Fore.GREEN}creation.create_specific(creation.WEATHER) started at:{helpers.time_format()}\n')
    ...
    pg.keyUp("shift")
    time.sleep(0.5)
    print(f'{Fore.GREEN}monuments.build(monuments.BLACK_HOLE) started at:{helpers.time_format()}\n')
    ...
    pg.keyUp("shift")
    time.sleep(0.5)
    print(f'{Fore.GREEN}monuments.upgrade(monuments.BLACK_HOLE) started at:{helpers.time_format()}\n')
    ...
    pg.keyUp("shift")
    time.sleep(0.5)
    print(f'{Fore.GREEN}monuments.upgrade(monuments.TEMPLE_OF_GOD) started at:{helpers.time_format()}\n')
    monuments.upgrade(monuments.TEMPLE_OF_GOD)
    time.sleep(30)
    # end_of_run()
    # monuments.black_hole()
    # monuments.black_hole_upgrade()
    print(f'{Fore.GREEN}gods.finger_flick() started at:{helpers.time_format()}\n')
    gods.finger_flick()
    time.sleep(3)
    for _ in range(3):
        gods.fight()
